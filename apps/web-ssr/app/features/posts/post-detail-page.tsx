...
import PostContent from '@rosti/ui/components/posts/PostContent'
    ...
    <article>
      ...
      <div className="border-b border-border/60">
        <div className="container mx-auto px-4 py-10 md:px-6 md:py-14">
          ...
          {/* Title */}
          <h1 className="mb-6 max-w-3xl font-display text-4xl font-black leading-[1.08] tracking-tight text-foreground md:text-5xl lg:text-6xl">
            {post?.title}
          </h1>
