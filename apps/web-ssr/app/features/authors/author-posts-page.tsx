...
import { publicAuthorControllerGetAuthorPosts } from '@rosti/openapi-generator/client/sdk.gen'
        ...
        <div className="container mx-auto px-4 py-12 md:px-6 md:py-16">
          ...
          <div className="flex items-start gap-5">
            ...
            <div>
              ...
              <h1 className="mb-1 font-display text-3xl font-black tracking-tight text-foreground md:text-4xl">
                {authorName}
              </h1>
