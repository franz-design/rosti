...
import {
  ...
  AccordionItem,
  AccordionTrigger,
} from '@rosti/ui/components/primitives/accordion'
import {
  Avatar,
  AvatarFallback,
  AvatarGroup,
  AvatarGroupCount,
  AvatarImage,
} from '@rosti/ui/components/primitives/avatar'
...
import { Checkbox } from '@rosti/ui/components/primitives/checkbox'
...
import {
  ...
  InputGroupInput,
  InputGroupText,
} from '@rosti/ui/components/primitives/input-group'
import { Label } from '@rosti/ui/components/primitives/label'
import { MultiSelect } from '@rosti/ui/components/primitives/multi-select'
import {
  Popover,
  PopoverContent,
  PopoverHeader,
  PopoverTitle,
  PopoverTrigger,
} from '@rosti/ui/components/primitives/popover'
import {
  Progress,
  ProgressLabel,
  ProgressValue,
} from '@rosti/ui/components/primitives/progress'
import { RadioGroup, RadioGroupItem } from '@rosti/ui/components/primitives/radio-group'
...
import { Switch } from '@rosti/ui/components/primitives/switch'
import {
  Table,
  TableBody,
  TableCell,
  ...
  TableHeader,
  TableRow,
} from '@rosti/ui/components/primitives/table'
import {
  Tabs,
  TabsContent,
  TabsList,
  TabsTrigger,
} from '@rosti/ui/components/primitives/tabs'
import {
  Tooltip,
  TooltipContent,
  TooltipProvider,
        ...
        <div className="flex-1 min-w-0 space-y-12">
          ...
          <div className="relative overflow-hidden rounded-lg border border-border bg-card p-8">
            ...
            <div className="relative">
              ...
              <h1 className="mb-2 font-display text-4xl font-black tracking-tight text-foreground md:text-5xl">
                {t('components.title')}
              </h1>
