...
> This file is auto-generated by `pnpm --filter @rosti/documentation generate:index`.
...
- [pitchkit-product.mdx](./src/content/docs/explanations/pitchkit-product.mdx) - Domain model and feature map for the Rösti club manager
...
- [pitchkit-production.mdx](./src/content/docs/guides/pitchkit-production.mdx) - How to deploy Rösti (API, SPA, SSR, mobile) to staging and production
