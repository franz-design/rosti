...
Do not assign a whole DTO onto an entity whose fields live elsewhere. Prefer assigning only what belongs on that entity; keep versioning and collection rebuilds as explicit steps.
